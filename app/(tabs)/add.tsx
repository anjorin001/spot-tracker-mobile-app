...
import { createSpot } from "@/lib/storage";
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.headerSub}>Log a place you want to remember</Text>
      </View>
      ...
      >
        ...
        <View style={styles.field}>
          ...
          {imageUri ? (
            <View>
              ...
              <Pressable onPress={onPickImage} style={styles.changePhotoBtn}>
        ...
        <View style={styles.field}>
          ...
          {locationLabel ? (
            ...
            <Pressable onPress={onCaptureLocation} style={styles.locationBtn} disabled={locLoading}>
              {locLoading ? (
